  ...
  <section class="knowledge-footer">
    ...
    <div class="knowledge-grid">
      <div class="knowledge-card">
        <h3>BEGINNER</h3>
        <p>Start with ChatGPT or Claude. Ask questions, learn concepts, get help. It's free and revolutionary.</p>
      </div>
      <div class="knowledge-card">
        <h3>BUILDER</h3>
      ...
      <div class="knowledge-card">
        <h3>FUTURE</h3>
        <p>The tools on this site are free forever. Use them to learn, earn, and shape the AI future.</p>
      </div>
    </div>
    <div class="cta-box">
